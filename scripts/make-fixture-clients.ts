      ...
      phases: [
        {
          ...
          window: "",
          objective:
            "Close the capture and response gaps, in the order the figures in this report put them.",
          deployActions: [
            ...
            "Install the webchat widget and connect the social page inbox to the same queue.",
            `Build the booking page against real ${s.trade.worker} availability and put it behind every call to action.`,
          ],
          owner: "us",
          doneDefinition: [
        ...
        },
        {
          ...
          goLive: {
            ...
            whatWeNeedFromYou: [
              ...
              `Confirm the hours and the ${s.trade.worker} availability the calendar books against.`,
        ...
        },
        {
          phase: "",
          window: "",
          objective: "Run the qualification engine, keep the sequences honest, and report on what changed.",
          deployActions: [
            "Run qualification and routing on every enquiry, every day.",
            "Review scoring accuracy monthly and adjust the thresholds against booked outcomes.",
            `Rotate follow-up and reactivation copy each season so it stays relevant around ${s.trade.peak}.`,
